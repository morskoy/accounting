...
class DevicesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','getmodel'),
				'users'=>array('@'),
			),
    ...
    public function actiongetManufactures() {
        ...
        if (Yii::app()->request->isAjaxRequest && isset($_POST['id_unit'])) {

            $data=Manufactures::model()->findAll('id_unit=:id_unit',
                array(':id_unit'=>(int) $_POST['id_unit']));

            $data=CHtml::listData($data,'id','manufacture');
